            ...
            <div class="">
                <div class="row ">
                    <div class="col-sm-1 comp-grid">
                        <a  class="btn btn btn-primary btn-block" href="<?php print_link("users/add") ?>">
                                    ...
                                    foreach ($records as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <th class="td-btn">
                                                ...
                                                <a class="btn btn-sm btn-success has-tooltip" title="<?php print_lang('btn_view_tooltip'); ?>" href="<?php print_link('users/view/' . $data['id']); ?>">
                                                    <i class="fa fa-eye"></i> <?php print_lang('empty_record_prompt'); ?>
                                                </a>


                                                <a class="btn btn-sm btn-info has-tooltip" title="<?php print_lang('btn_edit_tooltip'); ?>" href="<?php print_link('users/edit/' . $data['id']); ?>">
