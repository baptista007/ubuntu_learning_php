            ...
            <div class="">
                <div class="row ">
                    <div class="col-sm-1 comp-grid">
                        <a  class="btn btn btn-primary btn-block" href="<?php print_link("erven/manage_developer") ?>">
                    ...
                    <div class="page-records table-responsive">
                        <table class="table  table-striped table-sm">
                            <thead class="table-header bg-light">
                                <tr>
                                    <th class="td-sno">Company Name</th>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $data) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><a href="<?php print_link("erven/view_developer/{$data['id']}") ?>"><?php echo $data['name']; ?></a></td>
                                        <td> <?php echo $data['registration_number']; ?> </td>
                                        <td> <?= $this->getFormattedValueForDisplay($data['created']) ?> </td>

                                        <th class="td-btn">
                                            <a class="btn btn-sm btn-success has-tooltip" title="<?= VIEW_RECORD_MSG ?>" href="<?php print_link('erven/view_developer/' . $data['id']); ?>">
                                                <i class="fa fa-eye"></i> View
                                            </a>

                                            <a class="btn btn-sm btn-info has-tooltip" title="<?= EDIT_RECORD_MSG ?>" href="<?php print_link('erven/manage_developer/' . $data['id']); ?>">
                                                <i class="fa fa-edit"></i> Edit
                                            </a>

                                            <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="<?= EDIT_RECORD_MSG ?>" href="<?= print_link("erven/delete_developer/{$data['id']}"); ?>" >
