            ...
            <div class="">
                <div class="row ">
                    <div class="col-sm-1 comp-grid">
                        <a  class="btn btn btn-primary btn-block" href="<?php print_link("subjects/add") ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($records as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php print_link("subjects/view/$data[id]") ?>"><?php echo $data['name']; ?></a></td>
                                                    <td> <?php echo $data['grade_start']; ?> </td>
                                                    <td> <?php echo $data['grade_stop']; ?> </td>
                                                    <td> <?php echo $data['created']; ?> </td>
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="<?php print_lang('view_record'); ?>" href="<?php print_link('subjects/view/' . $data['id']); ?>">
                                                            <i class="fa fa-eye"></i> <?php print_lang(''); ?>
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="<?php print_lang('edit_this_record'); ?>" href="<?php print_link('subjects/edit/' . $data['id']); ?>">
