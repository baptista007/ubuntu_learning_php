...
?>
<div class="modal-dialog modal-lg" role="document" id="select-owner-sms-modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div id="select-owner-sms-feedback"></div>
            <?php
            if (!$records) {
            ...
            ?>
            <table class="table table-striped datatable" id="select-owner-sms-datatable">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    foreach ($records as $data) {
                        ...
                        <tr>
                            <td>
                                <label>
                                    <input 
                                        ...
                                        data-numbers="<?= $data['phone_numbers'] ?>"
                            ...
                            <td> <?php echo str_replace(",", "<br />", $data['phone_numbers']) ?> </td>
                        </tr>
                        <?php
                    }
                    ?>
        ...
        <div class="modal-footer">
            ...
            if ($records) {
                ?>
                <button type="button" class="btn btn-primary " id="select-owner-sms-add-btn">Add Selected</button>
                <?php
            }
            ?>
        </div>
