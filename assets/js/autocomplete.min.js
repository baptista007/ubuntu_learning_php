...
//                            if (!this.Input.hasAttribute("data-autocomplete-empty-callback")) {
//                                var callback = this.Input.getAttribute("data-autocomplete-empty-callback");
//                                if (callback && typeof (callback) === "function") {
//                                    callback(this.Input);
//                                }
//                            }
                            
                            if (this.Input.hasAttribute("data-autocomplete-value-control")) {
                                var elem = document.getElementById(this.Input.getAttribute("data-autocomplete-value-control"));
                        ...
                        _RenderResponseItems: function (response) {
                            ...
                            for (var item = 0; item < Math.min(Math.abs(limit), response.length); item++) {
                                ...
                                li.setAttribute("data-autocomplete-label", response[item].OriginalLabel);
                                ul.appendChild(li);
...
//                                this.Input.value = item.innerHTML;
                            ...
                            if (this.Input.hasAttribute("data-autocomplete-value-control")) {
                                ...
                                if (elem) {
                                    elem.value = value;
                                    this.Input.value = item.getAttribute("data-autocomplete-label");
                                }
                            } else {
                                this.Input.value = value;
                            }
