...
define('SITE_NAME', "Ubuntu Learning");
...
define('APP_ID', "6c6d3626c4011e48ec6a588544e8bf7e");
...
define('SITE_LOGO', IMG_DIR . "ubuntu-logo.png");
define('SITE_LOGO_SM', IMG_DIR . "ubuntu-logo-sm.png");
define('SITE_LOGO_SIGN_ONLY', IMG_DIR . "ubuntu-logo-so.png");
...
define('CUSTOM_MAX_UPLOAD_SIZE', 5242880);


// Application Page Settings
define("DEFAULT_PAGE", "info"); //Default Controller Class
...
if(!in_array($_SERVER['REMOTE_ADDR'], $whitelist)){
    define('DB_USERNAME', 'developer_osona');
    define('DB_PASSWORD', '#O?3Nb@$TF53');
    define('DB_NAME', 'developer_osona');
} else {
    define('DB_USERNAME', 'root');
    define('DB_PASSWORD', '');
    define('DB_NAME', 'ubuntu_learning');
}
...
define('INSERT_ERROR_MSG', 'Error inserting record');
define('UPDATE_ERROR_MSG', 'Error updating record');
define('RECORD_NOT_FOUND_MSG', 'Record not found');
define('VIEW_RECORD_MSG', 'View this record');
define('EDIT_RECORD_MSG', 'Edit this record');
define('DELETE_RECORD_MSG', 'Delete this record');
define('DELETE_ERROR_MSG', 'Error deleting record');
