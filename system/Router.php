...
class Router {
    ...
    function init() {
        ...
        #Set initial path
        if (empty($path)) {
            $path = DEFAULT_PAGE . "/" . DEFAULT_PAGE_ACTION;
        }
    ...
    function run($url) {
        ...
        if (class_exists($controller_name, true)) {
            ...
            if (method_exists($controller_name, $action)) {
                ...
                //Baptista on 11/09/2021
                //I don't see the benefit of this 
                //The POST values are still available using the $_POST
                //if (is_post_request()) {
                ...
                if (is_callable(array($controller, $action))) {
                    ...
                    $controller->status = ACL::GetPageAccess("$page/$action");
                    ...
                    if ($controller->status == AUTHORIZED) {
                        ...
                        $controller->render_view("index/login.php", null, "login_layout.php");
