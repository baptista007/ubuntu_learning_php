...
class Html {
    ...
    public static function page_header($arg = null) {
        if (user_login_status() == true) {
            ?>
            <div class="navbar navbar-expand-md fixed-left  navbar-dark bg-primary">
                ...
                <div id="side-navbar" class="navbar-dark bg-primary navbar-collapse collapse navbar-responsive-collapse">
                    <div class="form-group">
                        <ul class="nav navbar-nav w-100 flex-column align-self-start">
                            <li class="menu-profile nav-item">
                                <h5 class="user-name"><?php print_lang('txt_hi'); ?> <?php echo ucwords(USER_NAME); ?></h5>
                                <?php
                                ...
                                <div class="dropdown menu-dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php print_link('account') ?>"><i class="fa fa-user"></i> <?php print_lang('account'); ?></a>
        ...
        if (!empty($arrMenu)) {
            ...
            <ul class="<?php echo $menu_class; ?>">
                ...
                foreach ($arrMenu as $menuobj) {
                    $path = $menuobj['path'];
                    if (ACL::GetPageAccess($path) == 'AUTHORIZED') {
                        $active_class = null;
                        ...
                        <?php echo (!empty($menuobj['icon']) ? '<i class="fas ' . $menuobj['icon'] . '"></i>' : null); ?> 
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <?php echo (!empty($menuobj['icon']) ? '<i class="fas fa-' . $menuobj['icon'] . '"></i>' : null); ?> 
                                <?php echo $menuobj['label']; ?>
                                </a>
    ...
    /**
     * Convinient Function For Displaying Uploaded Files
     * @return Html
     */
    ...
    public static function addGoBackButtonRow() {
        ?>
        <div  class="bg-light p-3 mb-3">
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-sm-3 ">
                        <a  class="btn btn btn-warning text-white my-1" href="#" onclick="goBack();">
